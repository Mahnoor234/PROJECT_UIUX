  ...
  return (
    <nav className="bg-[#FBEBB5] px-6 py-4">
      <div className="flex items-center justify-between">
        {/* Left Section */}
        <div className="text-lg font-bold text-black hover:text-purple-900">
          MAHNOOR IMRAN
        </div>
  ...
  return (
    <>
      <button className="p-2">
        <User className="h-5 w-5 hover:bg-pink-600" />
        <span className="sr-only">Account</span>
      </button>
      <button className="p-2">
        <Search className="h-5 w-5 hover:bg-blue-500" />
        <span className="sr-only">Search</span>
      </button>
      <button className="p-2">
        <Heart className="h-5 w-5 hover:bg-red-600" />
        <span className="sr-only">Wishlist</span>
      </button>
      <button className="p-2">
        <ShoppingCart className="h-5 w-5 hover:bg-green-500" />
